...
class TowerGroup:
    ...
    def upgrade(self):
        ...
        # Make sure that the level do not exceed level 5. If more than 5 clicks, level of the tower is set to 1 again.

        if self.selected_tower.level < 5:
            self.selected_tower.level += 1      # level of the tower
        else:
